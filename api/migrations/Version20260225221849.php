...
final class Version20260225221849 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE game ADD finished TINYINT NOT NULL, ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL');
    ...
    {
        $this->addSql('ALTER TABLE game DROP finished, DROP created_at, DROP updated_at');
