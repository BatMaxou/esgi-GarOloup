...
final class Version20260712153530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE interrupt (number INT NOT NULL, id BINARY(16) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, game_id BINARY(16) NOT NULL, INDEX IDX_FBFF46D9E48FD905 (game_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE interrupt_action (id BINARY(16) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, role_source VARCHAR(255) DEFAULT NULL, team_source VARCHAR(255) DEFAULT NULL, interrupt_id BINARY(16) NOT NULL, discr VARCHAR(255) NOT NULL, INDEX IDX_C2A692DC6F38CC7A (interrupt_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE recap (game_id VARCHAR(36) NOT NULL, winning_team VARCHAR(255) NOT NULL, winning_role VARCHAR(255) DEFAULT NULL, players JSON NOT NULL, periods JSON NOT NULL, id BINARY(16) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE reveal_action (target_player_id VARCHAR(36) NOT NULL, seen_role VARCHAR(255) DEFAULT NULL, id BINARY(16) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE setup (id BINARY(16) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE setup_action (id BINARY(16) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, role_source VARCHAR(255) DEFAULT NULL, team_source VARCHAR(255) DEFAULT NULL, setup_id BINARY(16) NOT NULL, discr VARCHAR(255) NOT NULL, INDEX IDX_C3D72996CDCDB68E (setup_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE vote (number INT NOT NULL, resolved TINYINT NOT NULL, id BINARY(16) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, game_id BINARY(16) NOT NULL, eliminated_player_id BINARY(16) DEFAULT NULL, INDEX IDX_5A108564E48FD905 (game_id), INDEX IDX_5A108564B96971E1 (eliminated_player_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE vote_action (id BINARY(16) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, role_source VARCHAR(255) DEFAULT NULL, team_source VARCHAR(255) DEFAULT NULL, vote_id BINARY(16) NOT NULL, discr VARCHAR(255) NOT NULL, INDEX IDX_4B2BFEC872DCDAFC (vote_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE wild_child_model_action (target_player_id VARCHAR(36) NOT NULL, id BINARY(16) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE couple_action ADD CONSTRAINT FK_9E781042BF396750 FOREIGN KEY (id) REFERENCES setup_action (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE couple_death_interrupt_action ADD CONSTRAINT FK_154CB4ADBF396750 FOREIGN KEY (id) REFERENCES interrupt_action (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE couple_death_night_action ADD CONSTRAINT FK_3BF315EBF396750 FOREIGN KEY (id) REFERENCES night_action (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE couple_death_vote_action ADD CONSTRAINT FK_60BD8CA8BF396750 FOREIGN KEY (id) REFERENCES vote_action (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE game ADD CONSTRAINT FK_232B318CCDCDB68E FOREIGN KEY (setup_id) REFERENCES setup (id)');
        ...
        $this->addSql('ALTER TABLE interrupt ADD CONSTRAINT FK_FBFF46D9E48FD905 FOREIGN KEY (game_id) REFERENCES game (id)');
        $this->addSql('ALTER TABLE interrupt_action ADD CONSTRAINT FK_C2A692DC6F38CC7A FOREIGN KEY (interrupt_id) REFERENCES interrupt (id)');
        ...
        $this->addSql('ALTER TABLE pass_turn_event ADD CONSTRAINT FK_FCF980DBF396750 FOREIGN KEY (id) REFERENCES game_event (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE reveal_action ADD CONSTRAINT FK_ABBB57ADBF396750 FOREIGN KEY (id) REFERENCES night_action (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE setup_action ADD CONSTRAINT FK_C3D72996CDCDB68E FOREIGN KEY (setup_id) REFERENCES setup (id)');
        ...
        $this->addSql('ALTER TABLE vote ADD CONSTRAINT FK_5A108564B96971E1 FOREIGN KEY (eliminated_player_id) REFERENCES player (id)');
        $this->addSql('ALTER TABLE vote_action ADD CONSTRAINT FK_4B2BFEC872DCDAFC FOREIGN KEY (vote_id) REFERENCES vote (id)');
        ...
        $this->addSql('ALTER TABLE wild_child_model_action ADD CONSTRAINT FK_19DC0D6EBF396750 FOREIGN KEY (id) REFERENCES setup_action (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE couple_action DROP FOREIGN KEY FK_9E781042BF396750');
        $this->addSql('ALTER TABLE couple_death_interrupt_action DROP FOREIGN KEY FK_154CB4ADBF396750');
        $this->addSql('ALTER TABLE couple_death_night_action DROP FOREIGN KEY FK_3BF315EBF396750');
        $this->addSql('ALTER TABLE couple_death_vote_action DROP FOREIGN KEY FK_60BD8CA8BF396750');
        ...
        $this->addSql('ALTER TABLE game DROP FOREIGN KEY FK_232B318CCDCDB68E');
        ...
        $this->addSql('ALTER TABLE interrupt DROP FOREIGN KEY FK_FBFF46D9E48FD905');
        $this->addSql('ALTER TABLE interrupt_action DROP FOREIGN KEY FK_C2A692DC6F38CC7A');
        ...
        $this->addSql('ALTER TABLE pass_turn_event DROP FOREIGN KEY FK_FCF980DBF396750');
        ...
        $this->addSql('ALTER TABLE reveal_action DROP FOREIGN KEY FK_ABBB57ADBF396750');
        ...
        $this->addSql('ALTER TABLE setup_action DROP FOREIGN KEY FK_C3D72996CDCDB68E');
        ...
        $this->addSql('ALTER TABLE vote DROP FOREIGN KEY FK_5A108564B96971E1');
        $this->addSql('ALTER TABLE vote_action DROP FOREIGN KEY FK_4B2BFEC872DCDAFC');
        ...
        $this->addSql('ALTER TABLE wild_child_model_action DROP FOREIGN KEY FK_19DC0D6EBF396750');
        ...
        $this->addSql('DROP TABLE couple_action');
        $this->addSql('DROP TABLE couple_death_interrupt_action');
        $this->addSql('DROP TABLE couple_death_night_action');
        $this->addSql('DROP TABLE couple_death_vote_action');
        ...
        $this->addSql('DROP TABLE interrupt');
        $this->addSql('DROP TABLE interrupt_action');
        ...
        $this->addSql('DROP TABLE pass_turn_event');
        ...
        $this->addSql('DROP TABLE reveal_action');
