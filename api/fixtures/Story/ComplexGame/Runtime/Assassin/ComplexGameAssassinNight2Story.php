...
class ComplexGameAssassinNight2Story extends ComplexGameAssassinVote1ResolvedStory
{
    public function execute(): void
    {
        ...
        $victimPlayerBuilder = $this->getState($this->getWerewolfTarget());
    ...
    {
        return self::VILLAGER_5;
    }

    public function getPrefix(): string
    {
        return 'complex-game-assassin-night-2-';
    }
}
