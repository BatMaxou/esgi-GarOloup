...
Pour le front, les variables d'env sont consommées au build, il sera donc nécessaire de build l'image en local en suivant les étapes du workflow `front-image.yaml` car l'image node publique est branchée sur notre instance de l'app.
