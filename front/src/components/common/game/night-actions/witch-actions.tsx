      ...
      {!actionEnded ? (
        ...
        <div className="flex flex-col gap-4">
          ...
          {submittedActionType === 'poison' && submittedTargetName && (
            <Typography tag="p" variant="body-sm" className="text-error/80">
              {t('poisonVoteEndedWithTarget', { username: submittedTargetName })}
            </Typography>
          )}
          <Button
            type="button"
            ...
            variant="gradient"
            className="w-full"
            loading={timeUpLoading}
            disabled={timeUpLoading}
            label={t('timeUp')}
          />
        </div>
      )}
