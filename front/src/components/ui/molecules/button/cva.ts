  ...
  'h-fit flex items-center justify-center cursor-pointer border-2 transition-all focus:outline-none',
  {
    variants: {
      variant: {
        ...
        success: '',
        gradient:
          'bg-linear-(--primary-gradient) bg-origin-border hover:button-shadow-primary active:button-shadow-primary focus:button-shadow-primary',
        text: 'bg-transparent hover:underline active:underline focus:underline !p-0',
      },
      size: {
        lg: 'px-8 py-4 gap-4',
        md: 'px-6 py-3 gap-3',
    ...
    compoundVariants: [
      ...
      { size: ['sm', 'md', 'lg'], class: 'rounded-sm' },
      {
        ...
        glass: false,
        class:
          'bg-primary text-light hover:button-shadow-primary active:button-shadow-primary focus:button-shadow-primary',
      },
      {
        variant: 'primary',
        glass: true,
        class: cn(
          ...
          'active:bg-primary-pastel/20 active:border-primary',
      ...
      },
      {
        ...
        glass: false,
        class:
          'bg-secondary text-light hover:button-shadow-secondary active:button-shadow-secondary focus:button-shadow-secondary',
      },
      {
        variant: 'secondary',
        glass: true,
        class: cn(
          ...
          'active:bg-secondary/60 active:border-secondary-pastel/40',
      ...
      },
      {
        variant: 'accent',
        glass: false,
        class: 'bg-accent text-dark hover:button-shadow-accent active:button-shadow-accent focus:button-shadow-accent',
      },
      {
        variant: 'accent',
        glass: true,
      ...
      },
      {
        ...
        glass: false,
        class:
          'bg-foreground text-dark hover:button-shadow-foreground active:button-shadow-foreground focus:button-shadow-foreground',
      },
      {
        variant: 'neutral',
        glass: true,
        class: cn(
          ...
          'active:bg-foreground/20 active:border-foreground/40',
      ...
      },
      {
        variant: 'error',
        glass: false,
        class: 'bg-error text-light hover:button-shadow-error active:button-shadow-error focus:button-shadow-error',
      },
      {
        variant: 'error',
        glass: true,
        class: cn(
          ...
          'active:bg-error/10 active:border-error/40 active:text-error',
      ...
      },
      {
        ...
        glass: false,
        class:
          'bg-success text-light hover:button-shadow-success active:button-shadow-success focus:button-shadow-success',
      },
      {
        variant: 'success',
        glass: true,
        class: cn(
          ...
          'active:bg-success/10 active:border-success/40 active:text-success',
