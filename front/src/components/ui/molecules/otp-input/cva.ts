...
export const otpDigitCva = cva(
  cn(
    'shrink-0 text-center rounded-xs border-2 font-title font-bold transition-all outline-none',
    'caret-primary'
  ),
  {
    variants: {
      ...
      status: {
        ...
        success: cn(
          'bg-success/15 border-success text-light',
          'focus:border-success'
        ),
        error: cn(
          'bg-error/10 border-error text-light',
          'focus:border-error'
        ),
        disabled: cn(
